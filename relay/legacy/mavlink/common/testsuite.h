...
static void mavlink_test_connect(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_connect_t packet_in = {
		5,
	};
	mavlink_connect_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_connect_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_connect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_connect_pack(system_id, component_id, &msg , packet1.seq_number );
	mavlink_msg_connect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_connect_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.seq_number );
	mavlink_msg_connect_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_connect_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_connect_send(MAVLINK_COMM_1 , packet1.seq_number );
	mavlink_msg_connect_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_ack_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.drone_number = packet_in.drone_number;
        	packet1.seq_number = packet_in.seq_number;
        	packet1.map_number = packet_in.map_number;
	...
	mavlink_msg_ack_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ack_pack(system_id, component_id, &msg , packet1.drone_number , packet1.seq_number , packet1.map_number );
	mavlink_msg_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.drone_number , packet1.seq_number , packet1.map_number );
	mavlink_msg_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ack_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ack_send(MAVLINK_COMM_1 , packet1.drone_number , packet1.seq_number , packet1.map_number );
	mavlink_msg_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_cmdmsg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_cmdmsg_t packet_in = {
		17.0,
	45.0,
	73.0,
	41,
	...
	mavlink_cmdmsg_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.param1 = packet_in.param1;
        	packet1.param2 = packet_in.param2;
        	packet1.param3 = packet_in.param3;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_cmdmsg_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_cmdmsg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_cmdmsg_pack(system_id, component_id, &msg , packet1.seq_number , packet1.command_id , packet1.drone_number , packet1.param1 , packet1.param2 , packet1.param3 );
	mavlink_msg_cmdmsg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_cmdmsg_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.seq_number , packet1.command_id , packet1.drone_number , packet1.param1 , packet1.param2 , packet1.param3 );
	mavlink_msg_cmdmsg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_cmdmsg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_cmdmsg_send(MAVLINK_COMM_1 , packet1.seq_number , packet1.command_id , packet1.drone_number , packet1.param1 , packet1.param2 , packet1.param3 );
	mavlink_msg_cmdmsg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_navdata(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_navdata_t packet_in = {
		963497464,
	45.0,
	73.0,
	101.0,
	...
	mavlink_navdata_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.drone_state = packet_in.drone_state;
        	packet1.vx = packet_in.vx;
        	packet1.vy = packet_in.vy;
        	packet1.altitude = packet_in.altitude;
        	packet1.heading = packet_in.heading;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_navdata_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_navdata_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_navdata_pack(system_id, component_id, &msg , packet1.seq_number , packet1.drone_number , packet1.drone_state , packet1.vx , packet1.vy , packet1.altitude , packet1.heading , packet1.battery );
	mavlink_msg_navdata_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_navdata_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.seq_number , packet1.drone_number , packet1.drone_state , packet1.vx , packet1.vy , packet1.altitude , packet1.heading , packet1.battery );
	mavlink_msg_navdata_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_navdata_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_navdata_send(MAVLINK_COMM_1 , packet1.seq_number , packet1.drone_number , packet1.drone_state , packet1.vx , packet1.vy , packet1.altitude , packet1.heading , packet1.battery );
	mavlink_msg_navdata_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_vidstream(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vidstream_t packet_in = {
		5,
	72,
	...
	mavlink_vidstream_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.seq_number = packet_in.seq_number;
        	packet1.drone_number = packet_in.drone_number;
        
        	mav_array_memcpy(packet1.vidstream, packet_in.vidstream, sizeof(uint8_t)*128);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vidstream_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vidstream_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vidstream_pack(system_id, component_id, &msg , packet1.seq_number , packet1.drone_number , packet1.vidstream );
	mavlink_msg_vidstream_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vidstream_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.seq_number , packet1.drone_number , packet1.vidstream );
	mavlink_msg_vidstream_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vidstream_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vidstream_send(MAVLINK_COMM_1 , packet1.seq_number , packet1.drone_number , packet1.vidstream );
	mavlink_msg_vidstream_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_connect(system_id, component_id, last_msg);
	mavlink_test_ack(system_id, component_id, last_msg);
	mavlink_test_cmdmsg(system_id, component_id, last_msg);
	mavlink_test_navdata(system_id, component_id, last_msg);
	mavlink_test_vidstream(system_id, component_id, last_msg);
}
